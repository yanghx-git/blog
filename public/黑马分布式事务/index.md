...
![image-20200304201018438](黑马分布式事务.assets/image-20200304201018438.png)
...
![image-20200304202639509](黑马分布式事务.assets/image-20200304202639509.png)
...
![image-20200304204442839](黑马分布式事务.assets/image-20200304204442839.png)
...
![image-20200304205842784](黑马分布式事务.assets/image-20200304205842784.png) 
...
![image-20200304210120471](黑马分布式事务.assets/image-20200304210120471.png) 
...
![image-20200304210414309](黑马分布式事务.assets/image-20200304210414309.png) 

接下来，用户的读操作就会得到 v1。这就叫一致性。

![image-20200304210506575](黑马分布式事务.assets/image-20200304210506575.png) 

问题是，用户有可能向 G2 发起读操作，由于 G2 的值没有发生变化，因此返回的是 v0。G1 和 G2 读操作的结果不一致，这就不满足一致性了。

![image-20200304210521364](黑马分布式事务.assets/image-20200304210521364.png)

为了让 G2 也能变为 v1，就要在 G1 写操作的时候，让 G1 向 G2 发送一条消息，要求 G2 也改成 v1。

![image-20200304210540168](黑马分布式事务.assets/image-20200304210540168.png) 

这样的话，用户向 G2 发起读操作，也能得到 v1。

![image-20200304210557117](黑马分布式事务.assets/image-20200304210557117.png) 
...
![image-20200305141029973](黑马分布式事务.assets/image-20200305141029973.png) 
...
![image-20200305141318326](黑马分布式事务.assets/image-20200305141318326.png) 
...
- 单点故障问题
  ...
  ![image-20200305142812815](黑马分布式事务.assets/image-20200305142812815.png) 
...
![image-20200305155521612](黑马分布式事务.assets/image-20200305155521612.png) 
...
![image-20200305155830732](黑马分布式事务.assets/image-20200305155830732.png)
...
![image-20200305181454125](黑马分布式事务.assets/image-20200305181454125.png)
...
![image-20200305183431211](黑马分布式事务.assets/image-20200305183431211.png) 
...
![image-20200305200131083](黑马分布式事务.assets/image-20200305200131083.png)



一次消息发送的时序图：

![image-20200305205430863](黑马分布式事务.assets/image-20200305205430863.png)
...
![image-20200305212340203](黑马分布式事务.assets/image-20200305212340203.png)
...
![image-20200305213652558](黑马分布式事务.assets/image-20200305213652558.png)
...
![image-20200305214649845](黑马分布式事务.assets/image-20200305214649845.png)
...
![image-20200305225811888](黑马分布式事务.assets/image-20200305225811888.png)
...
![Saga 模式](黑马分布式事务.assets/1561965208439-606129fe-6761-4177-8887-1fda9306f104.png) 
...
![Seata](黑马分布式事务.assets/1561960344792-8810110b-1eda-4417-944e-7051ca52f90d.png)
...
Seata 会有 4 种分布式事务解决方案，分别是 AT 模式、TCC 模式、Saga 模式和 XA 模式。![image-20200305230513415](黑马分布式事务.assets/image-20200305230513415.png) 
...
![image-20200306164728739](黑马分布式事务.assets/image-20200306164728739.png)
...
![image-20200306170419354](黑马分布式事务.assets/image-20200306170419354.png) 

找到项目所在目录，选中并打开：

![image-20200306170520985](黑马分布式事务.assets/image-20200306170520985.png) 

项目结构如下：

![image-20200306171827203](黑马分布式事务.assets/image-20200306171827203.png) 
...
![image-20200306173439268](黑马分布式事务.assets/image-20200306173439268.png) 

库存：

![image-20200306173511332](黑马分布式事务.assets/image-20200306173511332.png) 
...
![image-20200306173343839](黑马分布式事务.assets/image-20200306173343839.png) 

查看数据库数据：

余额：

![image-20200306173602942](黑马分布式事务.assets/image-20200306173602942.png) 

库存：

![image-20200306173629491](黑马分布式事务.assets/image-20200306173629491.png) 

订单：

![image-20200306173700813](黑马分布式事务.assets/image-20200306173700813.png) 
...
![image-20200306173916953](黑马分布式事务.assets/image-20200306173916953.png)

看下用户余额：

![image-20200306224048175](黑马分布式事务.assets/image-20200306224048175.png) 

因为扣款失败，因此这里没有扣减

来看下库存数据：

![image-20200306174001901](黑马分布式事务.assets/image-20200306174001901.png) 
...
![image-20200306174740064](黑马分布式事务.assets/image-20200306174740064.png) 



然后解压即可，其目录结构如下：

![image-20200306174818712](黑马分布式事务.assets/image-20200306174818712.png) 
...
![image-20200306201749660](黑马分布式事务.assets/image-20200306201749660.png) 
...
![image-20200306223043452](黑马分布式事务.assets/image-20200306223043452.png)
