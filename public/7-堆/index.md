...
![image-20200706195127740](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706195127740.png)
...
![image-20200706200739392](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706200739392.png)
...
![image-20200706201904057](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706201904057.png)
...
![image-20200706203419496](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706203419496.png)

堆空间内部结构，JDK 1.8 之前从永久代 替换成 元空间

![image-20200706203835403](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706203835403.png)
...
![截屏](https://blog-1257196793.cos.ap-beijing.myqcloud.com/%E6%88%AA%E5%B1%8F.png)

```java
-XX:+PrintGCDetails
```

![image-20200706205821919](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706205821919.png)

#### 2.1  OutOfMemory举例

![image-20200706205947535](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706205947535.png)

![image-20200706210000461](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706210000461.png)
...
![image-20200706211652779](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200706211652779.png)
...
![image-20200707075847954](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707075847954.png)

下面这参数开发中一般不会调：

![image-20200707080154039](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707080154039.png)
...
![image-20200707084208115](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707084208115.png)
...
![image-20200707084714886](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707084714886.png)
...
![image-20200707085232646](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707085232646.png)

我们继续不断的进行对象生成 和 垃圾回收，当Survivor中的对象的年龄达到15的时候，将会触发一次 Promotion晋升的操作，也就是将年轻代中的对象 晋升到 老年代中

![image-20200707085737207](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707085737207.png)
...
![image-20200707091058346](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707091058346.png)
...
![垃圾回收](https://blog-1257196793.cos.ap-beijing.myqcloud.com/%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6.png)
...
因为Java对象大多都具备 朝生夕灭 的特性，所以Minor GC非常频繁，一般回收速度也比较快。这一定义即清晰又易于理解。

Minor GC 会引发STW，暂停其他用户的线程，等垃圾回收结束，用户线程才回复运行。

> STW : stop the word

![image-20200707095606813](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707095606813.png)

#### 5.2 Major GC

只发生在老年代的GC，对象从老年代消失时，我们说 "Major GC" 或“Full GC”发生了

出现了 Major GC，经常会伴随至少一次的Minor GC（但非绝对的，在Paralle Scavenge收集器的手机策略里就有直接进行Major GC的策略选择过程）

- 也就是在老年代空间不足时，会先尝试触发MinorGC。如果之后空间还不足，则触发Major GC

Major GC的速度一般会比Minor GC满1e倍以上，STW的时间更长，如果Major GC后，内存还不足，就报OOM了
...
![image-20200707101511025](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707101511025.png)

其实不分代完全可以，分代的唯一理由就是优化GC性能。如果没有分代，那所有的对象都在一块，就如同把一个学校的人都关在一个教室。GC的时候要找到哪些对象没用，这样就会对堆的所有区域进行扫描。而很多对象都是朝生夕死的，如果分代的话，把新创建的对象放到某一地方，当GC的时候先把这块存储“朝生夕死”对象的区域进行回收，这样就会腾出很大的空间出来。

![image-20200707101543871](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707101543871.png)
...
![image-20200707103547712](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707103547712.png)
...
![image-20200707104253530](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707104253530.png)
...
![image-20200707203038615](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707203038615.png)
...
![image-20200707203441718](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707203441718.png)
...
![image-20200707205634266](https://blog-1257196793.cos.ap-beijing.myqcloud.com/image-20200707205634266.png)
